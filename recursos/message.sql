drop database if exists vota_DDBB;
create database vota_DDBB;
...
create table if not exists `poll-answer-question`(
...
create table if not exists `user-poll`(
	`up_id` int NOT NULL AUTO_INCREMENT,
	`user_id` int NOT NULL,
	`PAQ_id` int NOT NULL,
  PRIMARY KEY (`up_id`),
  FOREIGN KEY (`user_id`) references `user`(`user_id`),
  FOREIGN KEY (`PAQ_id`) references `poll-answer-question`(`PAQ_id`)
